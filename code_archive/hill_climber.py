...
def generate_run_name():
    ...
    """
    adjectives = [
        "happy", "brave", "calm", "delightful", "eager",
        "fancy", "graceful", "jolly", "lively", "merry",
        "nice", "proud", "silly", "witty", "zealous",
                "sun", "moon", "star", "cloud", "river",
        "mountain", "forest", "ocean", "bird", "wind",
        "snow", "rain", "storm", "fire", "earth"
    ]
    
    nouns = [
        "sun", "moon", "star", "cloud", "river",
        "mountain", "forest", "ocean", "bird", "wind",
        "snow", "rain", "storm", "fire", "earth",        "happy", "brave", "calm", "delightful", "eager",
        "fancy", "graceful", "jolly", "lively", "merry",
        "nice", "proud", "silly", "witty", "zealous"
    ]
